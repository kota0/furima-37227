class PurchaseAddress
  ...
  with_options presence: true do
   ...
   def save
    ...
    Address.create(postal_code: postal_code, area_id: area_id, city: city, house_number: house_number, building_name: building_name, telephone_number: telephone_number, purchase: purchase)
   end
